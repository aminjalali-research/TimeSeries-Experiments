...
if __name__ == '__main__':
    ...
    out_dir = "results/results_amcgs_final_bekhoda"
    ...
    for repeat in range(1):
        for amc_instance in [0.1 , 0.5, 1, 3, 5]:
            for amc_temporal in [0.1, 0.5, 1, 3, 5]:
                    # for margin in np.linspace(0,1, 21):
                        margin = 0.5

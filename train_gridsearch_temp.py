...
if __name__ == '__main__':
    ...
    out_dir = "results/results_tempgs_final"
    ...
    for amc_instance in [0]:
        for amc_temporal in [0]:
            for amc_margin in [0.5]:
                for tau_min in [0.07, 0.1, 0.3, 0.4]:
                    for tau_max in [0.6, 0.7, 0.8, 1.0]:
                        for t_max in [1, 5,10, 20, 50]:
                                    accs = []
                                    auprcs = []
                                    for repeat in range(1):
                                        ...
                                        amc_settings['amc_margin'] = amc_margin
                                        ...
                                        print('temp setting : ', list(temp_settings.values()), 'amc setting : ', list(amc_settings.values()), "\nfinal res : ", final_res)
                                        # print('amc setting : ', amc_settings, "\nfinal res : ", final_res)
                                        # print(final_res)

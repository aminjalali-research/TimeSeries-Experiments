...
if __name__ == '__main__':
    ...
    out_dir = "results/reults_all_search_chinatown"
    ...
    for repeat in range(1):
        ...
        for amc_instance in [0, 0.1 , 0.5, 1, 3]:
            for amc_temporal in [0, 0.1, 0.5, 1, 3]:
                    # for margin in np.linspace(0,1, 10):
                for tau_min in [0.07, 0.1, 0.3]:
                    for tau_max in [0.6, 0.8, 1.0]:
                        for t_max in [5,10, 20]:
